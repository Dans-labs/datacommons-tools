export function Input({ label, ...props }: { label: string } & React.InputHTMLAttributes<HTMLInputElement>) {
  return (
    <div className="relative my-4 max-w-full group">
      ...
      <fieldset className="inset-0 absolute border-2 border-gray-600 rounded-xl pointer-events-none mt-[-9px] invisible peer-placeholder-shown:visible transition-all duration-300 group-focus-within:!border-primary group-focus-within:border-2 group-hover:border-gray-300">
      ...
      <fieldset className="inset-0 absolute border-2 border-gray-600 rounded-xl pointer-events-none mt-[-9px] visible peer-placeholder-shown:invisible transition-all duration-300 group-focus-within:border-2 group-focus-within:!border-primary group-hover:border-gray-300">
